...
# Mae ekama ichenjo go pairs kod display
AVAILABLE_PAIRS = ["CAD=X", "BTC-USD", "EURJPY=X", "USDJPY=X", "GBPUSD=X", "GBPJPY=X", "AUDUSD=X", "EURUSD=X"]
PAIR_DISPLAY_NAMES = {
    "CAD=X": "USD/CAD",
    "BTC-USD": "BTC/USD",
    "EURJPY=X": "EUR/JPY",
...
def fetch_and_analyze_data(selected_pair):
    ...
    for interval in intervals:
        ...
        try:
            # Fetch historical data up to the current date (date only, no time)
